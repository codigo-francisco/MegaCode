...
public class Constants {
    ...
    public static final int INITIAL_AMMO = Integer.MAX_VALUE;
    public static final int INITIAL_LIVES = Integer.MAX_VALUE;
    ...
    public static final String HUD_SCORE_LABEL = "Puntaje: ";
    ...
    public static final int POWERUP_SCORE